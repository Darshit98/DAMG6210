...
CREATE TABLE `tweet_tags` (
  ...
  CONSTRAINT `tweet_id_fk1` FOREIGN KEY (`tweet_id`) REFERENCES `tweet_table` (`tweet_ids`)
...
INSERT INTO `tweet_tags` VALUES (1591334,'#NortheasternUniversity #neu #FYDU'),(15913234,'#universityofvirgina #FYDU'),(159127255,'#FYDU#CIT');
